 ...
 ******************************************************************************/
package com.viddu.handlebars.maven;
...
public class HandlebarsMojo extends AbstractMojo {
     ...
     * 
     * @param inputFile
     *            : The uncompiled Handlebars template file
    ...
    protected String compile(Scriptable globalScope, File inputFile) throws IOException {
        ...
        Object result = compileContext.evaluateString(compileScope, "Handlebars.precompile(template);", "PreCompile",
                0, null);
    ...
    protected Scriptable loadHandlebarsLibrary(File hbrLib) {
        ...
        try {
            ...
            handlebarContext.evaluateReader(globalScope, handlebarsReader, "Handlebars Library", 0, null);
        } catch (IOException e) {
